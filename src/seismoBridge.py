...
"""
Copyright University of Georgia, 2022
Authored by Interstitial Technology, PBC
Licensed under the CERN OHL v2 (Strongly Reciprocal)
...
if __name__ == '__main__':
   ...
   dest = {'ip':'https://sensorweb.us', 'db':'shake', 'user':'test', 'passw':'sensorweb'}
    ...
    """
    some serial ports require a write operation to start sending data out, then
    uncomment below and replace with a serial write program
    """
